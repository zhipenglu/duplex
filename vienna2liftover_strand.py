...
python vienna2liftover.py aln.vienna aln.liftoverchain tstrand qstrand

"""""""""

import sys

print "Usage: python vienna2liftover.py aln.vienna aln.liftoverchain tstrand qstrand"
...
headers = ['chain', '10000', aln1name, str(aln1size), tstrand, str(tlead), str(aln1size-ttrail), \
           aln2name, str(aln2size), qstrand, str(qlead), str(aln2size-qtrail), '1']
header = "\t".join(headers)
